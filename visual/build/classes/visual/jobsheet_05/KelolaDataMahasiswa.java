    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        ...
        if (nim.getText().equals("")) {
            JOptionPane.showMessageDialog(
                    this, // objek parent yaitu JFrame
                    "NIM tidak boleh kosong!", // isi pesan
                    "Informasi", // judul pesan
                    JOptionPane.INFORMATION_MESSAGE // tipe pesan yang akan menentukan
            // icon pesan yang akn digunakan
            );
            nim.requestFocus();
            ...
            if (modeSimpan == true) { // simpan data baru
                model.addRow(
                        ...
                        new Object[]{
                            name.getText(), // data nim
                            nim.getText() // data nama
                        }
                );
            } else { // simpan data lama
                // nim
                tabel.setValueAt(
